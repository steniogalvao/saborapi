...
public interface DespolpApi {
	...
	@ApiOperation( value = "Deleta despolpa.", notes = "Deleta funcionário.\\n", response = Success.class, tags = { "Despolpa", } )
	@ApiResponses( value = { @ApiResponse( code = 200, message = "Resultado da ação.", response = Success.class ), @ApiResponse( code = 200, message = "Unexpected error", response = Success.class ) } )
	@RequestMapping( value = "/despolp/{id}", produces = { "application/json" }, method = RequestMethod.DELETE )
	ResponseEntity<String> despolpUuidDELETE( @ApiParam( value = "Id do funcionário.", required = true ) @PathVariable( "id" ) String id, @ApiParam( value = "Token de autenticação.", required = true ) @RequestParam( value = "accessToken", required = true ) String accessToken );

	@ApiOperation( value = "Busca despolpa.", notes = "Recupera uma despolpa.\\n", response = Despolp.class, tags = { "Despolpa", } )
	...
	ResponseEntity<String> despolpUuidGET( @ApiParam( value = "Id do funcionário.", required = true ) @PathVariable( "id" ) String id, @ApiParam( value = "Token de autenticação.", required = true ) @RequestParam( value = "accessToken", required = true ) String accessToken );
	...
	ResponseEntity<String> despolpUuidPUT( @ApiParam( value = "Id do funcionário.", required = true ) @PathVariable( "id" ) String id, @ApiParam( value = "Token de autenticação.", required = true ) @RequestParam( value = "accessToken", required = true ) String accessToken, @ApiParam( value = "Dados da despolpa.", required = true ) @RequestBody Despolp despolp );
