...
public interface EmployeeApi {
	...
	ResponseEntity<String> employeeUuidDELETE( @ApiParam( value = "Id do funcionário.", required = true ) @PathVariable( "id" ) String id, @ApiParam( value = "Token de autenticação.", required = true ) @RequestParam( value = "accessToken", required = true ) String accessToken );

	@ApiOperation( value = "Usuário.", notes = "Recupera um funcionário para ser editado.\\n", response = Employee.class, tags = { "User", } )
	...
	ResponseEntity<String> employeeUuidGET( @ApiParam( value = "Id do funcionário.", required = true ) @PathVariable( "id" ) String id, @ApiParam( value = "Token de autenticação.", required = true ) @RequestParam( value = "accessToken", required = true ) String accessToken );
	...
	ResponseEntity<String> employeeUuidPUT( @ApiParam( value = "Id do funcionário.", required = true ) @PathVariable( "id" ) String id, @ApiParam( value = "Token de autenticação.", required = true ) @RequestParam( value = "accessToken", required = true ) String accessToken, @ApiParam( value = "Dados do funcionário.", required = true ) @RequestBody Employee employee );
