...
import br.com.vsg.saborapi.api.ExpensesApi;
...
public class ExpensesApiController implements ExpensesApi {
	...
	public ResponseEntity<String> expensesGET( @ApiParam( value = "Token de autenticação.", required = true ) @RequestParam( value = "accessToken", required = true ) String accessToken ) {
		try {
			JsonNode json = expenseService.getAll();
